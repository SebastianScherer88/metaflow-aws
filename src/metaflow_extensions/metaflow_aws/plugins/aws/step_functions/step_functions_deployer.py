...
if TYPE_CHECKING:
    import metaflow_extensions.metaflow_aws.plugins.aws.step_functions.step_functions_deployer_objects


class CustomStepFunctionsDeployer(DeployerImpl):
    """
    ...
    def deployed_flow_type() -> (
        Type[
            "metaflow_extensions.metaflow_aws.plugins.aws.step_functions.step_functions_deployer_objects.CustomStepFunctionsDeployedFlow"
        ]
    ):
        from .step_functions_deployer_objects import CustomStepFunctionsDeployedFlow

        return CustomStepFunctionsDeployedFlow
    ...
    def create(
        ...
        return self._create(CustomStepFunctionsDeployedFlow, **kwargs)


_addl_stubgen_modules = [
    "metaflow_extensions.metaflow_aws.plugins.aws.step_functions.step_functions_deployer_objects"
]
